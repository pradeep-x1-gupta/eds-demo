...
var CustomImportScript = (() => {
  ...
  var PAGE_TEMPLATE = {
    ...
    description: "Top-level section landing: breadcrumb, page hero title band, and column-control content groups.",
    urls: ["https://about.kaiserpermanente.org/news"],
    blocks: [
      { name: "cards-news", instances: [".c05-column-control:has(.c08-feature)"] },
      { name: "cards-news-list", instances: [".c04-filtered-card-grid"] }
    ],
    sections: [
      { id: "section-1", name: "section-hero-title", selector: ".c14-page-hero", style: null, blocks: [], defaultContent: [".c14-page-hero"] },
      { id: "section-2", name: "section-promo-mosaic", selector: ".c05-column-control:has(.c08-feature)", style: null, blocks: ["cards-news"], defaultContent: [] },
      { id: "section-4", name: "section-news-grid", selector: ".c04-filtered-card-grid", style: null, blocks: ["cards-news-list"], defaultContent: [] }
    ]
  };
  var transformers = [
    transform,
