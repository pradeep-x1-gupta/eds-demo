...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-content-simple.js
  var import_content_simple_exports = {};
  __export(import_content_simple_exports, {
    default: () => import_content_simple_default
  });
  ...
  function parse(element, { document: document2 }) {
    ...
    linkListContainers.forEach((container) => {
      ...
      const anchors = [...container.querySelectorAll("a[href]")].filter((a) => !a.classList.contains("c17-link-list__link"));
  ...
  var PAGE_TEMPLATE = {
    name: "content-simple",
    description: "Simple interior content page: breadcrumb, page hero title band, single content region.",
    urls: ["https://about.kaiserpermanente.org/who-we-are/labor-relations"],
    blocks: [
      { name: "cards-news", instances: [".c05-column-control"] }
    ],
    sections: [
      { id: "section-1", name: "section-hero-title", selector: ".c14-page-hero", style: "grey", blocks: [], defaultContent: [".c14-page-hero"] },
      { id: "section-2", name: "section-labor-mosaic", selector: ".c05-column-control", style: null, blocks: ["cards-news"], defaultContent: [] }
    ]
  };
  var transformers = [
    transform,
  ...
  var import_content_simple_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_content_simple_exports);
})();
