...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-leadership-bio.js
  var import_leadership_bio_exports = {};
  __export(import_leadership_bio_exports, {
    default: () => import_leadership_bio_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "leadership-bio",
    description: "Executive bio: name/title + headshot header band, then bio body prose.",
    urls: ["https://about.kaiserpermanente.org/who-we-are/leadership-team/greg-a-adams"],
    blocks: [
      { name: "columns-bio", instances: [".c05-column-control:has(.c31-leadership-bio)"] }
    ],
    sections: [
      { id: "section-1", name: "section-bio-header", selector: ".c05-column-control:has(.c31-leadership-bio)", style: "grey", blocks: ["columns-bio"], defaultContent: [] },
      { id: "section-2", name: "section-bio-body", selector: ".c05-column-control:has(.c07-text)", style: null, blocks: [], defaultContent: [".c05-column-control:has(.c07-text)"] }
    ]
  };
  var transformers = [
    transform,
  ...
  var import_leadership_bio_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_leadership_bio_exports);
})();
